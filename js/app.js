...
const S = {
  ...
  tool: 'pen', color: '#f6c90e', size: 4, opacity: 1.0,
...
function updateDrawCursor() {
  ...
  const isToolsHidden = $('room').classList.contains('tools-hidden');
  ov.overlayRoot.classList.toggle('drawing-mode', S.tool!=='select' && !isToolsHidden);
}
